...
//        a_Tag_free_trial_full_match.click();
        ...
        //if the text Start a free trial is changed in next version we can use partial LinkText

        WebElement a_Tag_free_trial_partial_match = driver.findElement(By.partialLinkText("trial"));
        a_Tag_free_trial_partial_match.click();
